...
#[derive(Debug)]
pub struct MemoryPoolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MemoryPoolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MemoryPool processing");
    
    let mut processor = MemoryPoolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MemoryPoolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MemoryPoolProcessor::new(false);
